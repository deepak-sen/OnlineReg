...
<body>
    ...
    <img  src="/img/caricon.png" >
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="{{ url ('/members/successlogin')}}">License Reg.</a></li>
  ...
  <!--Feature-->
   ...
   <section id="testimonial" class="section-padding">
      ...
      <div class="row">
        <div class="header-section text-center">
          <h2 class="white">Vehicle Registrations</h2>
  ...
  <li>
    ...
    <form method="get" action="/members/vehiclelogin/{{ $vehicle->id }}/vedit">
...
<posts></posts>
     ...
     <br/><br/> 
    <form method="get" action="/members/vehiclelogin/vcreate">
    <button type="submit" id="submit" name="submit" class="form contact-form-button light-form-button oswald light">New Vehicle Registration</button>
</form>
